...
female_path = glob("./data/female/*.jpg") # Returns a list of paths matching a pathname pattern
# print(female_path)
# print(type(female_path)) # list
male_path = glob("./data/male/*.jpg")
# print(female_path)

print(len(female_path)) # 7000
print(len(male_path)) # 7000
...
# let's convert the image to gray scale for haar cascade classifier
gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY) # cvtColor = convert color
...
# extract_images(female_path[0], 'female', 1) # Check extract_images
